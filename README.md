...
| --- | -------------  |  -------------  |  -------------  | 
| Beginner |  [**Evaluate Dialogflow CX Agent Answers**](intro.ipynb) | [<img align="center" src="https://colab.research.google.com/assets/colab-badge.svg" />](https://colab.research.google.com/github/stanfordnlp/dspy/blob/main/intro.ipynb)  |  Basic eval of DFCX agent answers using DFCX-Scrapi and DSPy |
